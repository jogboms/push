...
Class Router
{
   ...
   */
     ...
     * HEAD Request
     */
    public function head($route, $controller = null)
    {
      return $this->map(func_get_args())->methods('HEAD');
    }
    /**
     * PATCH Request
     */
    public function options($route, $controller = null)
    {
      return $this->map(func_get_args())->methods('OPTIONS');
    }
